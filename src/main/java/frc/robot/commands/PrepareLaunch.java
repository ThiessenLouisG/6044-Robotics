...
public class PrepareLaunch extends Command {
  ...
  public void initialize() {
    ...
    m_launcher.setLeftLaunchWheel(kLeftLauncherSetpoint);
    m_launcher.setRightLaunchWheel(kRightLauncherSetpoint);
    m_launcher.setFeedWheel(kLaunchFeederSpeed);
    System.out.println("Launcher On");
  }
  ...
  public void end(boolean interrupted) {
    ...
    m_launcher.setLeftLaunchWheel(0);
    m_launcher.setRightLaunchWheel(0);
    m_launcher.setFeedWheel(0);
    System.out.println("Launcher Off");
  }
